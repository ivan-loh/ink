...
pub use config::{
    ...
    WorkspaceConfig, list_profiles, load_config, profile_bound_email, resolve_profile, save_config,
    set_active_profile, set_profile_bound_email, set_profile_server,
};
